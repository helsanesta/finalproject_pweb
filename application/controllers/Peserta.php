...
class Peserta extends CI_Controller
{
    ...
    public function view_admin_peserta_perpanjang()
    {
        ...
        if ($this->session->userdata('logged_in') == true and $this->session->userdata('id_user_level') == 1) {
            ...
            $this->load->view('admin/peserta_perpanjang', $data);
    ...
    public function view_perusahaan()
    {
        ...
        if ($this->session->userdata('logged_in') == true and $this->session->userdata('id_user_level') == 2) {
            ...
            $data['user'] = $this->m_user->get_all_user()->result_array();
            $this->load->view('perusahaan/peserta', $data);
    ...
    public function update_peserta()
    {
        ...
        $foto_name = md5($nama_lengkap . $nik . rand(1, 9999) . $tanggal_tes . $username);
