...
class Dashboard extends CI_Controller {
	...
	public function view_admin()
	{
		...
		$data['peserta'] = $this->m_user->count_all_user()->row_array();
		$data['peserta_acitve'] = $this->m_user->count_all_user_active()->row_array();
		$data['peserta_no_active'] = $this->m_user->count_all_user_no_active()->row_array();
