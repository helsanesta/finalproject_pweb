...
class Perusahaan extends CI_Controller
{
    ...
    public function tambah_perusahaan()
    {
        ...
        $id_status_aktif = 1;
        $id_user_level = 2;
        $id_user = md5($nama_perusahaan . $tanggal_tes . $email);
        ...
        $hasil = $this->m_user->insert_perusahaan($id_user, $username, $password, $email, $nama_perusahaan,
            $jenis_perusahaan, $npwp_perusahaan, $formasi_jabatan, $lokasi_tes, $alamat, $tanggal_tes, $deskripsi, $nomor_telepon, $logo['file_name'], $id_status_aktif, $id_status_verifikasi, $id_user_level);
    ...
    public function update_perusahaan()
    {
        ...
        $hasil = $this->m_user->update_perusahaan($id_user, $nama_perusahaan,
            $jenis_perusahaan, $npwp_perusahaan, $formasi_jabatan, $lokasi_tes, $alamat, $tanggal_tes, $deskripsi, $nomor_telepon, $logo['file_name']);
    ...
    public function verifikasi_data()
    {
        ...
        $subject = 'Status Verifikasi Kartu Peserta';
