...
<head>
    ...
    <title>WEB | SSCASN-KKP | JATIM</title>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="<?= base_url();?>assets/logoku.png" />
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo me-auto">
                <h1><a href="<?=base_url();?>Login/login_user">SSCASN-KKP | JATIM</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#cta">Daftar</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center"
                    data-aos="fade-up">
                    <div>
                        <h1>SISTEM SELEKSI CALON APARATUR SIPIL NEGARA</h1>
                        <h2> Kementerian Kelautan dan Perikanan Jawa Timur</h2>
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-contents-center" data-aos="fade-left">
                        <div class="content pt-4 pt-lg-0">
                            <h3>Tentang Kementerian Kelautan dan Perikanan</h3>
                            <p class="fst-italic">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vitae neque ultricies, fringilla dolor nec, dictum arcu. Maecenas vehicula erat lorem, vel efficitur ex placerat ac. Donec congue suscipit massa. Morbi diam diam, posuere ac tempus ut, gravida vel risus. Pellentesque sodales orci sit amet arcu mattis commodo. Donec feugiat velit a leo porttitor aliquam. Pellentesque quis sapien sed libero auctor pellentesque in eu massa. Fusce suscipit neque at libero aliquam sagittis. Phasellus rutrum quam non enim suscipit, tempus aliquam ipsum tincidunt. Ut nibh leo, gravida id consectetur sed, tempus at ante. Pellentesque at ipsum ex. Sed sollicitudin quam ac dui molestie, et gravida est euismod. Suspendisse potenti.
                            </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-contents-center" data-aos="fade-left">
                        <div class="content pt-4 pt-lg-0">
                            <h3>Visi</h3>
                            <p class="fst-italic">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vitae neque ultricies, fringilla dolor nec, dictum arcu. Maecenas vehicula erat lorem, vel efficitur ex placerat ac. Donec congue suscipit massa. Morbi diam diam, posuere ac tempus ut, gravida vel risus. Pellentesque sodales orci sit amet arcu mattis commodo.
                            </p>
                            <h3>Misi</h3>
                            <ul>
            ...
            <div class="container">
                ...
                <div class="row" data-aos="zoom-in">
                    <div class="col-lg-9 text-center text-lg-start">
                        <h3>Daftar Seleksi ASN KKP 2022</h3>
                    ...
                    <div class="col-lg-12 d-flex align-items-stretch" data-aos="fade-right">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Jl. Jenderal Sudirman No.70, Pati Kidul, Kec. Pati, Kabupaten Pati, Jawa Tengah 59114</p>
                            </div>
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253356.7280118513!2d112.52429004990748!3d-7.160769236461823!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fb429acb2317%3A0xa81a02e6d0fa07b0!2sDinas%20Kelautan%20dan%20Perikanan%20Provinsi%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1671472814340!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="footer-info">
                            <h3>SSCASN-KKP | JATIM</h3>
                            <p>
                                Jl. Ahmad Yani No.152 B, Gayungan, Kec. Gayungan, Kota SBY, Jawa Timur 60235<br><br>
                                <strong>Phone:</strong> (031) 8292326<br>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-8 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="#cta">Daftar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
