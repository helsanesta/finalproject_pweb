    ...
    <table style="height: 197px; width: 800px;">
        <tbody>
            <tr style="height: 8.95px;">
                ...
                <td style="width: 97.4875px; height: 8.95px;"><strong>Formasi Jabatan</strong></td>
                <td style="width: 95.5125px; height: 8.95px;"><strong>Lokasi Tes</strong></td>
                <td style="width: 79px; height: 8.95px;"><strong>Alamat</strong></td>
                <td style="width: 100px; height: 8.95px;"><strong>Tanggal Tes</strong></td>
            ...
            <tr style="height: 91px;">
                ...
                <td style="width: 97.4875px; height: 91px;"><?=$formasi_jabatan?></td>
                <td style="width: 95.5125px; height: 91px;"><?=$lokasi_tes?></td>
                <td style="width: 79px; height: 91px;"><?=$alamat?></td>
                <td style="width: 108px; height: 91px;"><?=$tanggal_tes?></td>
