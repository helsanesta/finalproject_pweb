                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Daftar Kartu Peserta</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col">
                        ...
                        <form action="<?=base_url();?>Daftar/lengkapi_data_user" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="formasi_jabatan" name="formasi_jabatan" placeholder="Kepala/Wakil/Staff"
                                    value="<?=$formasi_jabatan?>" <?php  if($id_status_aktif == '2' OR $id_status_perpanjangan == '2' OR $id_status_verifikasi == '2' OR $akhir_berlaku != NULL){
                                        echo 'disabled';
                                    }else{
                                        echo 'required';
                                    }  ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="lokasi_tes" name="lokasi_tes" placeholder="Gresik/Madiun/Surabaya"value="<?=$lokasi_tes?>" <?php  if($id_status_aktif == '2' OR $id_status_perpanjangan == '2' OR $id_status_verifikasi == '2' OR $akhir_berlaku != NULL){
                                        echo 'disabled';
                                    }else{
                                        echo 'required';
                                    }  ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tanggal_tes" name="tanggal_tes"
                                    value="<?=$tanggal_tes?>" <?php  if($id_status_aktif == '2' OR $id_status_perpanjangan == '2' OR $id_status_verifikasi == '2' OR $akhir_berlaku != NULL){
                                        echo 'disabled';
                                    }else{
                                        echo 'required';
                                    }  ?>>
