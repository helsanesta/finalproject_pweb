        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Alur Perpanjangan Kartu Peserta</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid mb-2">
                    ...
                    <h2 class="text-center" style="margin-top:50px;">Alur Perpanjangan Kartu Peserta</h2>
                            ...
                            <div class="col">
                                ...
                                <div class="row d-flex justify-content-center">
                                    <p class="text-center">4. Operator akan memverifikasi anda dan mengaktifkan button
                                        print
                                        Kartu Pencari Kerja/Peserta di akun anda. </p>
                                </div>
                            </div>
                            <div class="col mt-5">
                                <div class="row d-flex justify-content-center">
