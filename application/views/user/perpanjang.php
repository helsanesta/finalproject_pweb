                    ...
                    <div class="col">
                        ...
                        <form action="<?=base_url();?>Perpanjang/lengkapi_data_user" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="formasi_jabatan" name="formasi_jabatan"
                                    value="<?=$formasi_jabatan?>" required>
                            </div>
                            <div class="form-group">
                                <label for="lokasi_tes">Lokasi Tes</label>
                                <input type="text" class="form-control" id="lokasi_tes" name="lokasi_tes" value="<?=$lokasi_tes?>"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="tanggal_tes">Tanggal Tes</label>
                                <input type="text" class="form-control" id="tanggal_tes" name="tanggal_tes"
