...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-responsive">
                                                        <div class="table table-striped table-hover ">
                                                            <a href="" class="btn btn-primary" data-toggle="modal"
                                                                data-target="#ubah_peserta<?=$id_user?>">
                                                    ...
                                                    <div class="table-responsive">
                                                        <div class="table table-striped table-hover ">
                                                            <a href="" data-toggle="modal"
                                                                data-target="#delete_peserta<?=$id_user?>"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?=base_url();?>Peserta/verifikasi_data"
                                                                method="POST">
                                            ...
                                            <div class="modal fade" id="aktifkan_kartu<?=$id_user?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?=base_url();?>Peserta/aktif_data"
                                                                method="POST">
                                                                <input type="text" name="email" value="<?=$email?>"
                                                                    hidden>
                                                                <input type="text" name="id_user" value="<?=$id_user?>"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" id="pesan" rows="3"
                                                                        name="pesan">Kepada yang terhormat Bpk/Ibu <?=$nama_lengkap?>, Kartu Pencari Kerja Peserta anda telah aktif !</textarea>
                                                                </div>
                                                                <div class="form-group">
                                            ...
                                            <!-- Modal Ubah Data -->
                                            <div class="modal fade" id="ubah_peserta<?=$id_user?>" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="<?=base_url();?>Peserta/update_peserta"
                                        ...
                                        echo '';
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="formasi_jabatan" name="formasi_jabatan"
                                                                        value="<?=$formasi_jabatan?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="lokasi_tes">Lokasi Tes</label>
                                                                    <input type="text" class="form-control" id="lokasi_tes"
                                                                        name="lokasi_tes" value="<?=$lokasi_tes?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="tanggal_tes">Tanggal Tes</label>
                                                                    <input type="text" class="form-control"
                                                                        id="tanggal_tes" name="tanggal_tes"
                                                                        value="<?=$tanggal_tes?>" required>
                                                                </div>
                                                                <div class="form-group">
                                            ...
                                            <!-- Modal Delete Data -->
                                            <div class="modal fade" id="delete_peserta<?=$id_user?>" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= base_url();?>Peserta/hapus_peserta"
        ...
        <!-- Modal Tambah Data -->
        <div class="modal fade" id="tambah_peserta" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="<?=base_url();?>Peserta/tambah_peserta" enctype="multipart/form-data"
                            method="POST">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="formasi_jabatan">Formasi Jabatan</label>
                                <input type="text" class="form-control" id="formasi_jabatan" name="formasi_jabatan" required>
                            </div>
                            <div class="form-group">
                                <label for="lokasi_tes">Lokasi Tes</label>
                                <input type="text" class="form-control" id="lokasi_tes" name="lokasi_tes" required>
                            </div>
                            <div class="form-group">
                                <label for="tanggal_tes">Tanggal Tes</label>
                                <input type="text" class="form-control" id="tanggal_tes" name="tanggal_tes" required>
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
