...
class M_user extends CI_Model
{
    ...
    {
        $hasil = $this->db->query("SELECT  COUNT(id_user) as total_peserta FROM user JOIN user_detail ON user.id_user_detail = user_detail.id_user_detail 
    ...
    $alamat, $foto_saya, $foto_ktp, $foto_ijazah, $foto_akte, $foto_surat_pengalaman_kerja, $foto_transkrip_nilai, $id_status_verifikasi, $id_status_perpanjangan, $id_status_aktif, $id_user_level)
    {
       ...
       jurusan, pengalaman_kerja, no_hp, formasi_jabatan, lokasi_tes, tanggal_tes, alamat, foto_saya, foto_ktp, foto_ijazah, foto_akte, foto_surat_pengalaman_kerja, foto_transkrip_nilai, id_status_verifikasi, id_status_aktif, id_status_perpanjangan, date_registered) 
       ...
       '$jurusan','$pengalaman_kerja','$no_hp','$formasi_jabatan','$lokasi_tes','$tanggal_tes','$alamat',
    ...
    $pendidikan_terakhir, $jurusan, $pengalaman_kerja, $no_hp, $formasi_jabatan, $lokasi_tes, 
    $tanggal_tes, $alamat, $foto_saya, $foto_ktp, $foto_ijazah, $foto_akte, $foto_surat_pengalaman_kerja, $foto_transkrip_nilai, $id_status_verifikasi, $id_status_perpanjangan, $id_status_aktif )
    {
        ...
        pendidikan_terakhir='$pendidikan_terakhir', jurusan='$jurusan', pengalaman_kerja='$pengalaman_kerja', no_hp='$no_hp', formasi_jabatan='$formasi_jabatan', lokasi_tes='$lokasi_tes',
        tanggal_tes='$tanggal_tes', alamat='$alamat', foto_saya='$foto_saya', foto_ktp='$foto_ktp', foto_ijazah='$foto_ijazah', foto_akte='$foto_akte' , foto_surat_pengalaman_kerja='$foto_surat_pengalaman_kerja'  , foto_transkrip_nilai='$foto_transkrip_nilai', id_status_verifikasi='$id_status_verifikasi' 
    ...
    $jenis_perusahaan, $npwp_perusahaan, $formasi_jabatan, $lokasi_tes, $alamat, $tanggal_tes, $deskripsi, $nomor_telepon, $logo)
    {
        $this->db->trans_start();

        $this->db->query("UPDATE perusahaan_detail SET nama_perusahaan='$nama_perusahaan', jenis_perusahaan='$jenis_perusahaan', 
        npwp_perusahaan='$npwp_perusahaan', formasi_jabatan='$formasi_jabatan', lokasi_tes='$lokasi_tes', alamat='$alamat', tanggal_tes='$tanggal_tes', deskripsi='$deskripsi',
    ...
    $jenis_perusahaan, $npwp_perusahaan, $formasi_jabatan, $lokasi_tes, $alamat, $tanggal_tes, $deskripsi, $nomor_telepon, $logo, $id_status_aktif, $id_status_verifikasi, $id_user_level)
    {
        $this->db->trans_start();
        $this->db->query("INSERT INTO user(id_user, username, password, email ,id_user_level, id_user_detail) VALUES ('$id','$username','$password','$email','$id_user_level','$id')");
        $this->db->query("INSERT INTO perusahaan_detail(id_perusahaan_detail, nama_perusahaan, jenis_perusahaan,
        npwp_perusahaan, formasi_jabatan, lokasi_tes, alamat, tanggal_tes, deskripsi, nomor_telepon, logo, id_status_verifikasi, 
        id_status_aktif, date_registered) VALUES ('$id','$nama_perusahaan','$jenis_perusahaan','$npwp_perusahaan','$formasi_jabatan',
        '$lokasi_tes','$alamat','$tanggal_tes','$deskripsi','$nomor_telepon','$logo',
